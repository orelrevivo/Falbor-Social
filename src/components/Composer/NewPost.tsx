...
const NewPost = ({ feed }: NewPostProps) => {
  ...
  return (
    <Card
      className="cursor-pointer space-y-3 px-5 py-4 mb-5"
      onClick={handleOpenComposer}
    >
      <div className="flex items-center space-x-3">
        <Image
          alt={currentAccount?.username}
          className="size-11 cursor-pointer rounded-full border border-gray-200 bg-gray-200 dark:border-gray-700 object-cover"
          height={44}
